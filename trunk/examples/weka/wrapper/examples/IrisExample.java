...
public class IrisExample {
    ...
    public static void main(String[] args) throws Exception {
            ...
            dataset.load(new File("/home/dmilne/Desktop/Temp/iris.arff")) ;
            
            decider.train(new SMO(), dataset) ;

            //train a classifier using loaded training data.
            decider.buildClassifier(new SMO()) ;

            //save the classifier so we could skip training in future
            //unfortunately this doesn't make any checks to see if classifier
was trained on expected attributes
            //any idea how one would do that?
            decider.saveClassifier(new File("/home/dmilne/Desktop/Temp/iris.model")) ;

            //load the classifier saved previously
            //unfortunately this doesn't make any checks to see if classifier
was trained on expected attributes
            decider.loadClassifier(new File("/home/dmilne/Desktop/Temp/iris.model")) ;

            //build an instance that we can classify
            //this will check that all attributes are set (optional) and that
values are the correct type.
            ...
            //note: building training instances algorithmically is done in much
the same way

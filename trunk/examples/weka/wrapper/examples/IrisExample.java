...
import weka.wrapper.*;
import weka.wrapper.InstanceBuilder.BuildResponse;
...
public class IrisExample {
	...
	public static void main(String[] args) throws Exception {
		...
		dataset.load(new File("data/iris.arff")) ;
		...
		decider.save(new File("data/iris.model")) ;

		//load the classifier saved previously
		//unfortunately this doesn't make any checks to see if classifier was trained on expected attributes
		decider.load(new File("data/iris.model")) ;
